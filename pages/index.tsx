...
const Card: React.FC<CardProps> = ({href, imgSrc, layoutId}) => {
  return(
    ...
    <div className="relative h-20 md:h-40">
          <motion.img
            src={imgSrc}
            className="w-full h-full bg-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition"
            layoutId={layoutId}
          />
        </div>
  </Link>
...
export default function Home() {
  return (
    <div>
      <h1 className="text-4xl sm:text-6xl lg:text-7x1 mt-10 md: mt-24 leading-none font-extrabold tracking-light text-gray-900 ">
